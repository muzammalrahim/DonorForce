      ...
      <div class="project_details">        
   		 <?php  // Do not show Title if disabled from DFparems		
     		...
     		<div class="donate_button" align="left" style="margin-top:5px;">
     				<a href="<?php echo JRoute::_('index.php?option=com_donorforce&view=donationselection&project_id='.$i->project_id); ?>" class="btn btn-primary"><?php echo JText::_('Donate Now!'); ?></a>
     		</div>
