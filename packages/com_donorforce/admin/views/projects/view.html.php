...
class DonorforceViewProjects extends JViewLegacy
{
	protected $items;
	...
	protected function addToolBar() 
	{
		...
		JToolBarHelper::title(JText::_('Projects Management'), 'newsfeeds.png');
		...
		{
			JToolBarHelper::deleteList('', 'projects.delete', 'Delete');
	...
	public static function getActions($classId = 0)
	{
		...
		if (empty($classId)) {
			...
			$assetName = 'com_donorforce.projects.'.(int) $classId;
		}
	...
	protected function setDocument()
	{
		...
		$document->setTitle(JText::_('Project Administration'));
