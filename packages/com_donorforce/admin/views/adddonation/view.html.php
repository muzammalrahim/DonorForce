...
class DonorforceViewAdddonation extends JViewLegacy
{
	protected $form;
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		$user	= JFactory::getUser();
		JToolBarHelper::title(JText::_('Add Donation'), 'newsfeeds.png');
		...
		JToolbarHelper::save2new('adddonation.save2new');
