 ...
 */
class DonorforceModelProjects extends JModelList // <Component-name>View<Model-name>
{
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$filter_order = JRequest::getCmd('filter_order', 'a.project_id');
		...
		//parent::populateState('a.project_id', 'asc');
	...
	function getListQuery(){
		...
		$query->from('#__donorforce_project AS a');
